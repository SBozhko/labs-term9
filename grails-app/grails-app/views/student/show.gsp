	...
	<body>
		...
		<div id="show-student" class="content scaffold-show" role="main">
			...
			<ol class="property-list student">
				...
				<g:if test="${studentInstance?.gpa}">
				<li class="fieldcontain">
					<span id="gpa-label" class="property-label"><g:message code="student.gpa.label" default="Gpa" /></span>
					
						<span class="property-value" aria-labelledby="gpa-label"><g:fieldValue bean="${studentInstance}" field="gpa"/></span>
